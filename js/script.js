...
const COMMANDS = {
    ...
    Lessons Learned: "I learnt from past projects that the path to ensure a growth mindset in a business ecosystem is a process that combines the right tools for the team to grow from a human & professional point of view - the metrics you’ll need to make decisions - understand the workplace-team values, set goals, prioritize wellness and track progress (learning culture) . Value Chain requires exchangeable knowledge that line up throughout sustainable forms : sacrificing quality to accelerate delivery tends to backfire much more quickly than expected, because it affects our ability to continue, maintain and change. We are living in accelerated times and must not forget how we got here , as a measure of value and awareness. It's also important technicians understand the requisites and potential of their equipment (hardware & software) , so that error and security issues with equipment can be minimized and productivity-accountability maximized ( resources optimization ) . Besides developing training in soft skills, this is a recipe for getting out of overwhelm quickly and feeling bad about your workday: the difference between feeling awesome or awful at the end of the day. The more connected, proactive or knowledge sharing - being receptive to other points of view - , higher the quality exchange between employees and more productive / healthy workplaces -. 
    Upgrade, migrating knowledge ecosystems will deliver faster performance and creativity to all staff and do a quality valuable job.",   
