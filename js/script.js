...
const COMMANDS = {
    ...
    skills: '<span class="code">Languages:</span> Python, C#, Java, PHP, HTML, CSS, JavaScript <br><span class="code">Technologies:</span> Git, SQL<br><span class="code">Frameworks:</span> Adobe Editing Programs, Eclipse, SQL Server Management Studio, React.js, Vue.js, flex, Django, API Framework : Microsoft.Net ; Android Studio,  A-Frame, Unity',
