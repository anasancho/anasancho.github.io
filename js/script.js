...
const COMMANDS = {
    ...
    skills: '<span class="code">Languages:</span> Python, C#, Java, PHP, HTML, CSS, JavaScript <br><span class="code">Technologies:</span> Git, SQL<br><span class="code">Frameworks:</span> Adobe Editing Programs, React.js, Vue.js, Django,',
