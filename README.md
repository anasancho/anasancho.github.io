...
<i> The core knowledge which can’t be taught, comes from working on something of your own. </i>
  Sketching materials and tools are necessary for the development of ideas : Programming is not just for engineers . It is possible to create different kinds of programming languages and environments that engage people with visual and spatial minds beyond math or the technical approach. 
