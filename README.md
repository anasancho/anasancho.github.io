<p></p>
 ...
 <p></p> I combine technical expertise with creative problem-solving abilities, with a background in software development and experience in providing technical and audit support for technology integration roles, such as computer science, audiovisual, and administrative assistant. <b> -- { Critical Thinker and a Problem-Solver } -- </b> passionate about technology and people, understanding the details, looking for how things work to optimize results, analyzing situations that can be improved, and identifying needs that should be met. 
